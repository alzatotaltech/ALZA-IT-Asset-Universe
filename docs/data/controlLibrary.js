...
const d = (id, name, family, risk, topics, weight = 1, frameworks = [F.CIS, F.NIST, F.ISO], tags = [], applicability = ['core']) => ({ id, name, family, risk, weight, topics, frameworks, tags, applicability });
...
export function buildMasterControlLibrary() {
    const controls = [];
